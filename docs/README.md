...
1. Capture or update the written process first.
2. Add or revise its BPMN diagram.
3. Link the process document to the BPMN source and rendered image.
4. Review the change with the people who own that process.
5. Keep a decision record for important choices and trade-offs.
