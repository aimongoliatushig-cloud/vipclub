...
permission_query_conditions = {
	...
	"VIP Branch Sales Goal": "nomad_vip.permissions.core.get_branch_sales_goal_query_conditions",
}
...
has_permission = {
	...
	"VIP Branch Sales Goal": "nomad_vip.permissions.core.has_branch_sales_goal_permission",
}
...
scheduler_events = {
	"hourly": ["nomad_vip.api.attendance_policy.finalize_absences"],
	"daily": ["nomad_vip.tasks.media_retention.process_due_media_retention"],
	"cron": {
		"*/15 * * * *": ["nomad_vip.integrations.finex.sync_recent_sales"],
	},
}
