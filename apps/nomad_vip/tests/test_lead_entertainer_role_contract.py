...
class TestLeadEntertainerRoleContract(TestCase):
	...
	def test_only_lead_or_system_manager_can_submit_checklist(self):
		...
		self.assertIn('require_actor("Lead Entertainer", "Entertainer Supervisor", "System Manager")', text)
		self.assertNotIn('require_actor("Branch Manager"', text)
